...
import { RedisUssdInbox, UssdNotificationChannel } from "@/services/notifications/ussd/ussd-notification-channel";
...
async function main(): Promise<void> {
  ...
  const attempts = await runNotificationWorker(repository, { app: new InAppNotificationChannel(), email, sms, ussd: new UssdNotificationChannel(new RedisUssdInbox()) });
